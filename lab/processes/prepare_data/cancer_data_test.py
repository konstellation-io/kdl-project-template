...
def fixture_temp_cancer_data_dir(dir_temp="temp"):
    """
    Pytest fixture for the tests that require a data directory containing the cancer dataset arrays.
    As part of setup, the fixture creates those arrays in the temporary location specified
...
class TestCancerDataLoading:
    ...
    def test_load_data_splits_as_torch_tensors(self, temp_data_dir):
        """
        Tests that data splits can be loaded as torch tensors.
        Note: requires dir_temp populated with .npy files as generated by prepare_cancer_data, prepared by
        fixture_temp_cancer_data_dir
        """
    ...
    def test_load_data_splits_as_dataloader(self, temp_data_dir):
        """
        Tests that data splits can be loaded as torch DataLoader objects.
        Note: requires dir_temp populated with .npy files as generated by prepare_cancer_data, prepared by 
        fixture_temp_cancer_data_dir
        """
